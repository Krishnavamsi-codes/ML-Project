...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            num_pipeline = Pipeline(steps=[
                ("imputer", SimpleImputer(strategy='median')),## there are a lot of outliers
            ...
            logging.info("NUMERICAL FEATURES IMPUTATION AND SCALING COMPLETED")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("READ TEST AND TRAIN DATASETS")

            preprocessor_obj = self.get_data_transformer_object()

            target_variable = 'math score'
            input_features_train_df = train_df.drop(columns=[target_variable], axis=1)
            ...
            logging.info("APPLYING PRE-PROCESSING ON TRAIN AND TEST DATAFRAME")
