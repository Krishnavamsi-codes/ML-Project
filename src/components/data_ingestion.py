...
if __name__=='__main__':
    ...
    train_arr,test_arr,_=data_transformation.initiate_data_transformation(train_data,test_data)# returns 3 values we need only 2 for further

    modeltrainer=ModelTrainer()
    print(modeltrainer.initiate_model_training(test_arr,train_arr))
